...
<div class="wrap">
    <div class="bread_box">
        <a href="${pageContext.request.contextPath}/fore/forIndex">首页</a>
        <span> &gt;</span>
        <a href="${pageContext.request.contextPath}/route/findRoutes?cid=${category.cid}">${category.cname}</a><span> &gt;</span>
        <a href="#">${fn:substring(route.rname,0,20)}...</a>
    </div>
    <div class="prosum_box">
        ...
        <div class="prosum_right">
            <p class="pros_title">${fn:substring(route.rname,0,20)}...</p>
            ...
            <div class="pros_price">
                ...
                <p class="collect">
                    <c:if test="${flag}">
                        <a class="btn" href="#"  onclick="collect(${route.rid},${user.uid})">
